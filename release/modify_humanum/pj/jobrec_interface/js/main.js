$(document).ready(function(){
	$("#select-example").change(function() {
		if($(this).val() === "ex1") {
			$("#select-degree").val("bs");
			$("#select-major").val("Computer Science");
			$("#skills").val("NoSQL data stores (Cassandra, MongoDB) Hadoop, MySQL, Big Table, MapReduce, SAS, Large-scale, distributed systems design and development Scaling, performance and scheduling and ETL techniques, C, C++, Java, Ruby on Rails");
			$("#coursework").val("Data structures, Algorithms, Compiler, Operating systems, Databases");
			$("#certificate").val("Gradudate certificate in Data Mining");
			$("#projects").val("Work closely with various teams across the company to identify and solve business challenges utilizing large structured, semi-structured, and unstructured data in a distributed processing environment. Develop a new pricing strategy for Total Jeans that boosted margins by 2 percent and analyzed customer buying habits which correctly predicated the resurgence of dark blue denim giving us a jump on the competition.");
			$("#experience").val("Analyze large datasets to provide strategic direction to the company. Perform quantitative analysis of product sales trends to recommend pricing decisions. Conduct cost and benefit analysis on new ideas. Scrutinize and track customer behavior to identify trends and unmet needs. Develop statistical models to forecast inventory and procurement cycles. Assist in developing internal tools for data analysis. Coded, tested, debugged, implemented and documented apps using Java and Ruby. Developed eCommerce solutions and social networking functionality. Designed, developed and maintained eCommerce and social networking applications. Built report interfaces and data feeds. Gathered and collected information from various programs, analyzed time requirements and prepared documentation to change existing programs.");
		}
	}); 
	...
	$("#form").submit(function(e) {
		...
		$(".recommendation-wrapper").delay(2000).fadeIn();
        $('html, body').delay(2000).animate({ scrollTop: 0 }, 0);
	...
	$("#jr").click(function(e) {
        $("#select-example").val("ex1").change();
		$(".overview-wrapper").fadeOut();
		$(".example, form, .submit-button").fadeIn();
	});
...
['Info Tech', 'WI', 7],
['Info Tech', 'WV', 2],
['Customer Service', 'AZ', 4],
['Customer Service', 'CA', 9],
['Customer Service', 'CT', 2],
['Customer Service', 'DE', 3],
['Customer Service', 'FL', 17],
['Customer Service', 'GA', 3],
['Customer Service', 'ID', 16],
['Customer Service', 'IL', 6],
['Customer Service', 'IN', 1],
['Customer Service', 'KS', 2],
['Customer Service', 'KY', 1],
['Customer Service', 'LA', 1],
['Customer Service', 'MA', 6],
['Customer Service', 'MD', 1],
['Customer Service', 'ME', 3],
['Customer Service', 'MI', 3],
['Customer Service', 'MN', 5],
['Customer Service', 'MO', 2],
['Customer Service', 'MS', 3],
['Customer Service', 'MT', 1],
['Customer Service', 'NC', 7],
['Customer Service', 'ND', 3],
['Customer Service', 'NE', 1],
['Customer Service', 'NJ', 4],
['Customer Service', 'NM', 3],
['Customer Service', 'NV', 6],
['Customer Service', 'NY', 4],
['Customer Service', 'OH', 4],
['Customer Service', 'OK', 5],
['Customer Service', 'OR', 2],
['Customer Service', 'PA', 11],
['Customer Service', 'SC', 2],
['Customer Service', 'TN', 3],
['Customer Service', 'TX', 20],
['Customer Service', 'T', 39],
['Customer Service', 'VA', 2],
['Customer Service', 'WA', 2],
['Customer Service', 'WI', 7],
['Nurse', 'CA', 3],
['Nurse', 'CO', 1],
['Nurse', 'CT', 1],
['Nurse', 'KY', 2],
...
['Transportation', 'AL', 4],
['Transportation', 'AZ', 8],
['Transportation', 'CA', 40],
['Transportation', 'CO', 5],
['Transportation', 'CT', 27],
['Transportation', 'FL', 27],
['Transportation', 'GA', 5],
['Transportation', 'HI', 4],
['Transportation', 'IA', 3],
['Transportation', 'IL', 21],
['Transportation', 'IN', 19],
['Transportation', 'KS', 23],
['Transportation', 'KY', 4],
['Transportation', 'LA', 2],
['Transportation', 'MA', 2],
['Transportation', 'MD', 6],
['Transportation', 'ME', 2],
['Transportation', 'MI', 9],
['Transportation', 'MN', 14],
['Transportation', 'MO', 4],
['Transportation', 'MS', 4],
['Transportation', 'NC', 11],
['Transportation', 'ND', 1],
['Transportation', 'NE', 2],
['Transportation', 'NJ', 35],
['Transportation', 'NM', 3],
['Transportation', 'NV', 4],
['Transportation', 'NY', 29],
['Transportation', 'OH', 28],
['Transportation', 'OK', 23],
['Transportation', 'OR', 2],
['Transportation', 'PA', 21],
['Transportation', 'SC', 10],
['Transportation', 'TN', 10],
['Transportation', 'TX', 33],
['Transportation', 'T', 6],
['Transportation', 'VA', 4],
['Transportation', 'WA', 15],
['Transportation', 'WI', 10],
['Transportation', 'WV', 1],
['Transportation', 'WY', 3]
];

var width = 1100, height = 1010, margin ={b:15, t:50, l:280, r:50};

var svg = d3.select("#ind-body")
	.append("svg").attr('width',width).attr('height',(height+margin.b+margin.t))
	.append("g").attr("transform","translate("+ margin.l+","+margin.t+")");

var data = [ 
	{data:bP.partData(input_data,2), id:'JobCount', header:["Industry","State", ""]}
];
...
function dashboard(id, fData){
	...
	function segColor(c){ return {'Management':"#a6cee3", 'Transportation':"#1f78b4",'Finance':"#b2df8a", 'CustomerService':"#33a02c", 'Sales':"#fb9a99", 'Healthcare':"#e31a1c", 'Nurse':"#fdbf6f", 'Retail':"#ff7f00", 'Insurance':"#cab2d6", 'IT':"#6a3d9a"}[c]; }
    
    // compute total for each Skill.
    fData.forEach(function(d){d.total=d.freq.Management+d.freq.Transportation+d.freq.Finance+d.freq.CustomerService+d.freq.Sales+d.freq.Healthcare+d.freq.Nurse+d.freq.Retail+d.freq.Insurance+d.freq.IT;});
    ...
    function histoGram(fD){
        ...
        function mouseover(d){  // utility function to be called on mouseover.
            ...
            var st = fData.filter(function(s){ return s.Skill == d[0];})[0],
    ...
    function pieChart(pD){
        ...
        function mouseover(d){
            ...
            hG.update(fData.map(function(v){ 
                return [v.Skill,v.freq[d.data.type]];}),segColor(d.data.type));
        }
        //Utility function to be called on mouseout a pie slice.
        function mouseout(d){
            // call the update function of histogram with all data.
            hG.update(fData.map(function(v){
                return [v.Skill,v.total];}), barColor);
        }
    ...
    // calculate total frequency by segment for all Skill.
    var tF = ['Management', 'Transportation', 'Finance', 'CustomerService', 'Sales', 'Healthcare', 'Nurse', 'Retail', 'Insurance', 'IT'].map(function(d){ 
        return {type:d, freq: d3.sum(fData.map(function(t){ return t.freq[d];}))}; 
    });    
    
    // calculate total frequency by Skill for all segment.
    var sF = fData.map(function(d){return [d.Skill,d.total];});
...
var freqData=[
{Skill:'Software',freq:{'Management': 192, 'Transportation': 12, 'Finance': 185, 'CustomerService': 87, 'Sales': 158, 'Healthcare': 111, 'Nurse': 26, 'Retail': 82, 'Insurance': 347, 'IT': 680}}
,{Skill:'Database',freq:{'Management': 62, 'Transportation': 3, 'Finance': 82, 'CustomerService': 41, 'Sales': 46, 'Healthcare': 94, 'Nurse': 23, 'Retail': 9, 'Insurance': 231, 'IT': 342}}
,{Skill:'Sqlite',freq:{'Management': 19, 'Transportation': 3, 'Finance': 65, 'CustomerService': 1, 'Sales': 7, 'Healthcare': 32, 'Nurse': 0, 'Retail': 4, 'Insurance': 138, 'IT': 458}}
,{Skill:'Programming',freq:{'Management': 10, 'Transportation': 3, 'Finance': 32, 'CustomerService': 4, 'Sales': 10, 'Healthcare': 39, 'Nurse': 5, 'Retail': 1, 'Insurance': 46, 'IT': 151}}
,{Skill:'Java',freq:{'Management': 4, 'Transportation': 0, 'Finance': 4, 'CustomerService': 0, 'Sales': 5, 'Healthcare': 2, 'Nurse': 0, 'Retail': 0, 'Insurance': 70, 'IT': 169}}
,{Skill:'C',freq:{'Management': 17, 'Transportation': 38, 'Finance': 10, 'CustomerService': 17, 'Sales': 11, 'Healthcare': 17, 'Nurse': 1, 'Retail': 4, 'Insurance': 15, 'IT': 95}}
];

dashboard('#com-skills',freqData);


var freqData1=[
{Skill:'Modeling',freq:{'Management': 108, 'Transportation': 9, 'Finance': 55, 'CustomerService': 17, 'Sales': 17, 'Healthcare': 25, 'Nurse': 0, 'Retail': 70, 'Insurance': 63, 'IT': 78}}
,{Skill:'Analytics',freq:{'Management': 40, 'Transportation': 0, 'Finance': 79, 'CustomerService': 2, 'Sales': 13, 'Healthcare': 38, 'Nurse': 1, 'Retail': 7, 'Insurance': 107, 'IT': 78}}
,{Skill:'SAS',freq:{'Management': 2, 'Transportation': 0, 'Finance': 17, 'CustomerService': 0, 'Sales': 0, 'Healthcare': 34, 'Nurse': 0, 'Retail': 0, 'Insurance': 17, 'IT': 13}}
,{Skill:'Classification',freq:{'Management': 22, 'Transportation': 2, 'Finance': 9, 'CustomerService': 2, 'Sales': 12, 'Healthcare': 8, 'Nurse': 3, 'Retail': 10, 'Insurance': 6, 'IT': 8}}
,{Skill:'Mining',freq:{'Management': 1, 'Transportation': 0, 'Finance': 14, 'CustomerService': 5, 'Sales': 1, 'Healthcare': 11, 'Nurse': 3, 'Retail': 1, 'Insurance': 12, 'IT': 16}}
,{Skill:'R',freq:{'Management': 7, 'Transportation': 1, 'Finance': 3, 'CustomerService': 13, 'Sales': 13, 'Healthcare': 5, 'Nurse': 1, 'Retail': 14, 'Insurance': 0, 'IT': 6}}
];


dashboard('#stat-skills',freqData1);


var freqData2=[
{Skill:'Javascript',freq:{'Management': 6, 'Transportation': 0, 'Finance': 0, 'CustomerService': 0, 'Sales': 5, 'Healthcare': 1, 'Nurse': 0, 'Retail': 3, 'Insurance': 31, 'IT': 182}}
,{Skill:'HTML',freq:{'Management': 1, 'Transportation': 0, 'Finance': 14, 'CustomerService': 0, 'Sales': 4, 'Healthcare': 2, 'Nurse': 0, 'Retail': 3, 'Insurance': 31, 'IT': 109}}
,{Skill:'Cognos',freq:{'Management': 3, 'Transportation': 0, 'Finance': 10, 'CustomerService': 0, 'Sales': 0, 'Healthcare': 0, 'Nurse': 0, 'Retail': 1, 'Insurance': 27, 'IT': 29}}
,{Skill:'Tableau',freq:{'Management': 0, 'Transportation': 0, 'Finance': 16, 'CustomerService': 0, 'Sales': 0, 'Healthcare': 0, 'Nurse': 0, 'Retail': 0, 'Insurance': 33, 'IT': 17}}
,{Skill:'CSS',freq:{'Management': 2, 'Transportation': 0, 'Finance': 3, 'CustomerService': 1, 'Sales': 0, 'Healthcare': 0, 'Nurse': 0, 'Retail': 0, 'Insurance': 8, 'IT': 43}}
,{Skill:'Dashboard',freq:{'Management': 8, 'Transportation': 0, 'Finance': 0, 'CustomerService': 0, 'Sales': 4, 'Healthcare': 0, 'Nurse': 0, 'Retail': 3, 'Insurance': 0, 'IT': 11}}
];

dashboard('#vis-skills',freqData2);
...
function tooltipHtml(n, d){
	...
	"WI", "MO", "AR", "OK", "KS", "LS", "VA"]
		.forEach(function(d){ 
			var num=jobcnt[d];
			Data[d]={num:num,color:d3.interpolate("#fde0dd", "#c51b8a")(num/200)}; 
		});
    ...
    function start() {
        var rp1 = radialProgress(document.getElementById('div'))
                .diameter(200)
                .value(86)
                .render();
    }
